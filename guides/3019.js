...
module.exports = {
 ...
 //一王
  ...
  "s-3019-1000-106-0": [{"type": "text","sub_type": "message","message": "重击" }],
  "s-3019-1000-107-0": [{"type": "text","sub_type": "message","message": "后喷击退" }],
  "s-3019-1000-108-0": [{"type": "text","sub_type": "message","message": "点名击飞" }], 
  ...
  "s-3019-1000-307-0": [{"type": "text","sub_type": "message","message": "笼子禁锢" }],
  ...
  "s-3019-2000-114-0": [{"type": "text","sub_type": "message","message": "三连地板靠近" }].concat(SPAWNING_FIRST_CIRCLE_FLOWERS),
  "s-3019-2000-116-0": [{"type": "text","sub_type": "message","message": "前砸 后砸" }].concat(rings_left_right), 
  "s-3019-2000-301-0": [{"type": "text","sub_type": "message","message": "捶地远离 旋转击退" }].concat(SPAWNING_FIRST_CIRCLE_FLOWERS),
  "s-3019-2000-302-0": [{"type": "text","sub_type": "message","message": "旋转靠近 捶地击飞" }].concat(SPAWNING_FIRST_CIRCLE_FLOWERS), 
//三王
  ...
  "s-3019-3000-139-0": [{"type": "text","sub_type": "message","message": "右边安全" }].concat(rings_front_right_back),
  "s-3019-3000-150-0": [{"type": "text","sub_type": "message","message": "右边安全" }].concat(rings_front_right_back),
  "s-3019-3000-141-0": [{"type": "text","sub_type": "message","message": "左边安全" }].concat(rings_front_left_back), 
  "s-3019-3000-152-0": [{"type": "text","sub_type": "message","message": "左边安全" }].concat(rings_front_left_back),
